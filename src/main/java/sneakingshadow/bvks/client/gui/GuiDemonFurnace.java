...
public class GuiDemonFurnace extends GuiContainerBVKS {
    ...
    private final ResourceLocation textureLocation = new ResourceLocation(this.location + "demon_furnace.png");
    ...
    public void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        ResourceLocation textureLocation = new ResourceLocation(this.location + "demon_furnace.png");
    ...
    public void updateScreen() {
        ((ContainerDemonFurnace)this.inventorySlots).UpdateSlots();
    }
}

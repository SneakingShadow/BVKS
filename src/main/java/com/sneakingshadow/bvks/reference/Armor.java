...
public class Armor
{
    ...
    {
        public static final ItemArmor.ArmorMaterial DEVIL = EnumHelper.addArmorMaterial(Reference.MOD_ID+".devil", 100000, new int[] {6, 16, 12, 6}, 30);
        public static final ItemArmor.ArmorMaterial OBSIDIAN = EnumHelper.addArmorMaterial(Reference.MOD_ID+".obsidian", 24, new int[] {2,7,6,2}, 5);
    }
